...
1. After a drug is administered in a single injection, the rate at which the drug leaves the body is proportional to the quantity present.
    ...
    1. Suppose that 10 mg of a drug is injected into the bloodstream. 3 hours later, only 2 mg remains in the bloodstream. Find the formula for the amount of the drug $Q(t)$ after $t$ hours.
...
2. Suppose that  a drug is being administered at a constant rate of 60 mg/hour and its decreasing at a rate of 20% of the amount present.
    1. What differential equation models this process?
    1. Find the formula for the amount of drug $Q(t)$ after $t$ hours.
    1. What value does $Q(t)$ converge to for large values of $t$?
...
3. How large is the deer population when that population is growing  at its fastest rate?
