...
* Use desmos to fit a power function $y=kx^p$ to data using a command like $ln (y_1) ~ c + p ln(x_1)$ or $ln (y_1) ~ ln(k) + p ln(x_1)$ 
...
* Use RStudio to create a contour plot of $z=f(x,y)$ and interpret what you see.
