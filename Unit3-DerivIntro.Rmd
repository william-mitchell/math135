...
The **derivative of a function** $f$ at a point $c$ is the slope of the tangent line at $x=c$ .It's also sometimes called the **instantaneous rate of change**.
...
4. If we had the data for 1994 or 1996, using these valuues would give us a better estimate. Using smaller and smaller intervals will give us a more accurate estimation. (But we cannot tell up front how "small" we need to be to get the accurracy we desire.)
