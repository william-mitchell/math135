...
$$
f(x,y) = - x^4 -  x^3 + 10 x * y + y - 8 y^2 
$$
whose partial derivatives are
$$
\frac{\partial f}{\partial x} = -3 x^2 - 4 x^3 + 10 y
\quad \mbox{and} \quad
\frac{\partial f}{\partial x} = 10 x 2y - 16 y
$$
...
```{r}
partialx=makeFun(-3*x^2 - 4*x^3 + 10*y~x&y)
...
In this case, the optimal value of $38$ is achieved at approximately $(10, 55)$. Let's make another plot to confirm to get a better estimate.
