...
1. Does this grpph show any year-to-year seasonal patterns to unemployment? Explain.
...
h(0,0)
plotFun(1000* t*exp(-(5-x/1000)*t)~x&t, x.lim=c(0,4000),t.lim=c(0,4), levels=seq(0,1500,50), filled=FALSE)
```
