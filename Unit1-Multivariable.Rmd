...
V.lim=range(5,40),surface=TRUE,zlab="W",xlab="T",ylab="V")
```

Contour Plot

```{r}
plotFun(35.74+0.6215*T-35.75*V^(0.16)+0.4275*T*V^(0.16)~T & V, T.lim=range(-40,40), filled=FALSE,
V.lim=range(5,60),zlab="V",xlab="T",ylab="V", levels = seq(-100,40,10))
```
...
plotFun(P(x,y) ~ x&y, filled=FALSE, x.lim=range(-5,5),y.lim=range(-5,5), levels = seq(-1000, 1000, 200))
...
plotFun(W(T,20)~T, T.lim=range(-40,40), xlab="T",ylab="W",  main="Windchill for V=20",levels = seq(-100,40,10))

plotFun(W(T,40)~T, T.lim=range(-40,40), xlab="T",ylab="W",  main="Windchill for V=40",levels = seq(-100,40,10))

```


```{r}
plotFun(W(-20,V)~V, V.lim=range(0,60), xlab="V",ylab="W",  main="Windchill for T=-20")
...
plotFun(f(x,y) ~ x&y, filled=FALSE, x.lim=range(-3,3),y.lim=range(-3,3), levels = seq(0, 1, 0.25))
...
plotFun(g(x,y) ~ x&y, filled=FALSE, x.lim=range(-2,2), y.lim=range(-2,2), levels=seq(0,15,3))
...
plotFun(g(x,y) ~ x&y, filled=FALSE, x.lim=range(-5,5), y.lim=range(-3,3), levels=seq(0,4,0.5))
