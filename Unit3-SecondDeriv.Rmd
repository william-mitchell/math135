...
* $f'(c) > 0$ if and only if the function is increasing at $x=c$
* $f'(c) < 0$ if and only if the function is decreasing at $x=c$

The Second Derivative

* $f''(c) > 0$ if and only if the function is concave up at $x=c$
* $f'(c) < 0$ if and only if the function is concave down at $x=c$
