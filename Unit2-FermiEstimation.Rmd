...
2. Estimate what you don't know!
    ...
    b. Estimate (using an educated guess) the answers to the smaller questions. 
...
**Pro Tip \#1:** The key is to identify smaller problems that you can estimate using your everyday common sense. For example, rather than estimating the height of of  a building, I would estimate the height of one floor and estimate the number of floors, and then multiply.
...
The following approximate data may be useful in various Fermi problems. Each have been stated with one or two significant figures.
