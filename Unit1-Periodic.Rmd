...
The water level is modeled by a cosine curve shifted to the right. The water level has amplitude $(5.5 - (-0.5))/2) = 6/2=3$ and vertical shift $(5.5 + (-0.5))/2) = 3$. The period is $24.83$ hours, and we must shift to the right by one fourth of that amount, so $\phi=-24.83=-6.207$. So
$$ w(t) = 3 \cos \left( \frac{2 \pi}{24.83} ( t - 6.207) \right)$$
...
$$ r(t) = 2.5 \cos \left( \frac{2\pi}{12} ( t + 1) \right).$$
