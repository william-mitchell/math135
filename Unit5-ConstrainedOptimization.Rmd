...
2. For a budget of 20, the maximal production is $f(32,26)=310$. 
3. The Lagrange multiplier is
$$
\lambda = \frac{\triangle \mbox{production}}{\triangle \mbox{constraint}} \approx \frac{310-250}{20-15}=\frac{60}{5}=12  \frac{\mbox{units}}{\mbox{dollar}}
$$
So if we increase our budget by \$1, then we will produce 12 more units.

4. The Lagrange multiplier is approximately $12$ units/dollar. We will break even if we can sell one unit for $1/12=0.133$ dollars/unit. So if the sale price is at least \$0.083, we will decide to increase production.
